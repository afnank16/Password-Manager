                  ...
                  {editingId === entry.id ? (
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div className="bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 flex items-center justify-between gap-2">
                        ...
                        <div className="space-y-0.5 min-w-0 flex-1">
                          ...
                          <div className="flex flex-wrap items-center gap-x-3 text-xs text-slate-500 font-medium">
                            ...
                            <span className="flex items-center gap-2">
                              ...
                              <span className={`px-2 py-0.5 rounded text-xs tracking-wider ${visibleIds.includes(entry.id) ? "bg-blue-50 text-blue-600 border border-blue-100" : "bg-slate-100 text-slate-400"}`}>
                      ...
                      <div className="flex items-center gap-4 justify-between md:justify-end shrink-0 border-t md:border-none border-slate-100 pt-2 md:pt-0">
                        ...
                        <div className="flex items-center bg-slate-50 border border-slate-200/80 rounded-xl p-1">
                          <button
                            ...
                            className="p-2 text-slate-400 hover:text-slate-700 hover:bg-white rounded-lg transition shadow-none hover:shadow-sm"
                        ...
                        <div className="flex items-center gap-1.5">
                          <button
                            ...
                            className="p-2 bg-slate-50 hover:bg-slate-100 text-slate-500 hover:text-slate-800 border border-slate-200/60 rounded-xl transition"
                          >
                            <Edit2 className="w-3.5 h-3.5" />
                          </button>
                          <button
                            onClick={() => handleDelete(entry.id)}
                            className="p-2 bg-slate-50 hover:bg-red-50 text-slate-400 hover:text-red-600 border border-slate-200/60 rounded-xl transition"
                          >
